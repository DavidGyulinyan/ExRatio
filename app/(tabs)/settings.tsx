...
Thank you for choosing Capital!`,
      ...
      hy: `Capital-ի օգտագործման պայմանները

Ուժի մեջ մտնելու ամսաթիվը. հունվարի 10, 2025

Բարի գալուստ Capital: Մեր բջջային հավելվածը ("Հավելված") ներբեռնելով, տեղադրելով կամ օգտագործելով՝ դուք համաձայնում եք կապված լինել այս Օգտագործման Պայմաններով ("Պայմաններ"): Եթե դուք համաձայն չեք այս Պայմաններին, խնդրում ենք չօգտագործել Հավելվածը:

1. ԾԱՌԱՅՈՒԹՅԱՆ ՆԿԱՐԱԳՐՈՒԹՅՈՒՆ
Capital-ը ապահովում է իրական ժամանակի արժույթի փոխարկման գործիքներ և փոխարժեքների տեղեկատվություն անհատական և տեղեկատվական նպատակների համար: Մեր ծառայությունները ներառում են.
...
Capital-ին մուտք գործելով և օգտագործելով՝ դուք ընդունում եք և համաձայնում եք կապված լինել այս համաձայնագրի պայմաններով և դրույթներով: Այս Պայմաններն առնչվում են Հավելվածի բոլոր օգտատերերին:
...
Կիրառելի օրենսդրության առավելագույն չափով, Capital-ը և նրա մշակողները չեն կրի պատասխանատվություն՝
...
Շնորհակալություն Capital-ն ընտրելու համար!`,
